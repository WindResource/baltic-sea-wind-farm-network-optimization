...
def gen_dataset(output_folder: str):
    """
    Generates a dataset from the offshore substation layer in the current ArcGIS project 
    ...
    required_fields = ['OSS_ID', 'ISO', 'Longitude', 'Latitude', 'WaterDepth', 'IceCover', 'Distance']
    ...
    data_array = np.array(list(zip(array['OSS_ID'], array['ISO'], array['Longitude'], array['Latitude'], array['WaterDepth'], array['IceCover'], array['Distance'])), dtype=dtype)
