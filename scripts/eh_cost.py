class EH_cost:
    def check_supp(self, water_depth):
            """
    ...
    def equip_cost_lin(self, water_depth, support_structure, ice_cover, eh_capacity):
        """
    ...
    def inst_deco_cost_lin(self, supp_structure, port_distance, operation):
        """
